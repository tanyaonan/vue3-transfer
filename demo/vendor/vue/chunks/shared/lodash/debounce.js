...
import { o as e, u as t } from "./_baseAssignValue.js";
import { t as n } from "./toNumber.js";
//#region node_modules/.pnpm/lodash-es@4.18.1/node_modules/lodash-es/now.js
var r = function() {
	return t.Date.now();
}, i = "Expected a function", a = Math.max, o = Math.min;
function s(t, s, c) {
	var l, u, d, f, p, m, h = 0, g = !1, _ = !1, v = !0;
	if (typeof t != "function") throw TypeError(i);
	s = n(s) || 0, e(c) && (g = !!c.leading, _ = "maxWait" in c, d = _ ? a(n(c.maxWait) || 0, s) : d, v = "trailing" in c ? !!c.trailing : v);
	function y(e) {
		var n = l, r = u;
		return l = u = void 0, h = e, f = t.apply(r, n), f;
	}
	function b(e) {
