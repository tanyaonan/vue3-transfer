...
var g = /* @__PURE__ */ t(i()), _ = () => /*#__PURE__*/ g.createElement("svg", {
	width: "252",
	height: "294"
}, /*#__PURE__*/ g.createElement("title", null, "No Found"), /*#__PURE__*/ g.createElement("g", {
	fill: "none",
	fillRule: "evenodd"
	...
	strokeLinejoin: "round",
	strokeWidth: "1.1"
}))), v = () => /*#__PURE__*/ g.createElement("svg", {
	width: "254",
	height: "294"
}, /*#__PURE__*/ g.createElement("title", null, "Server Error"), /*#__PURE__*/ g.createElement("g", {
	fill: "none",
	fillRule: "evenodd"
}, /*#__PURE__*/ g.createElement("path", {
	fill: "#E4EBF7",
	...
	let { componentCls: t, lineHeightHeading3: n, iconCls: r, padding: i, paddingXL: o, paddingXS: s, paddingLG: c, marginXS: l, lineHeight: u } = e;
	return {
		[t]: {
			padding: `${a(e.calc(c).mul(2).equal())} ${a(o)}`,
			"&-rtl": { direction: "rtl" }
		},
		[`${t} ${t}-image`]: {
			width: e.imageWidth,
		...
		[`${t} ${t}-body`]: {
			marginTop: c,
			padding: `${a(c)} ${a(e.calc(i).mul(2.5).equal())}`,
	...
	return {
		[`${t}-success ${t}-icon`]: { color: e.resultSuccessIconColor },
		[`${t}-error ${t}-icon`]: { color: e.resultErrorIconColor },
		[`${t}-info ${t}-icon`]: { color: e.resultInfoIconColor },
		[`${t}-warning ${t}-icon`]: { color: e.resultWarningIconColor }
	};
}, x = (e) => [y(e), b(e)], S = h("Result", (e) => {
	let t = e.colorInfo, n = e.colorError, r = e.colorSuccess, i = e.colorWarning;
	return x(u(e, {
	...
	let { fontSizeHeading3: t, fontSize: n, paddingLG: r } = e;
	return {
		titleFontSize: t,
		subtitleFontSize: n,
		iconFontSize: p(t) ? t * 3 : `calc(${t} * 3)`,
		extraMargin: `${r}px 0 0 0`
	};
}), C = () => /*#__PURE__*/ g.createElement("svg", {
	width: "251",
	height: "294"
}, /*#__PURE__*/ g.createElement("title", null, "Unauthorized"), /*#__PURE__*/ g.createElement("g", {
	fill: "none",
	fillRule: "evenodd"
}, /*#__PURE__*/ g.createElement("path", {
	fill: "#E4EBF7",
	...
	500: v,
	403: C
}, D = Object.keys(E), O = ({ icon: e, status: t, className: n, style: r }) => {
	if (D.includes(`${t}`)) {
		let e = E[t];
		return /*#__PURE__*/ g.createElement("div", {
			className: n,
			style: r
		}, /*#__PURE__*/ g.createElement(e, null));
	}
	let i = /*#__PURE__*/ g.createElement(T[t]);
	return e === null || e === !1 ? null : /*#__PURE__*/ g.createElement("div", {
		className: n,
		style: r
	}, e || i);
}, k = ({ className: e, extra: t, style: n }) => t ? /*#__PURE__*/ g.createElement("div", {
	className: e,
	style: n
}, t) : null, A = (e) => {
	let { prefixCls: t, className: i, rootClassName: a, subTitle: o, title: s, style: c, children: l, status: u = "info", icon: p, extra: h, styles: _, classNames: v, ...y } = e, { getPrefixCls: b, direction: x, className: C, style: w, classNames: T, styles: E } = f("result"), A = {
		...e,
		status: u
	}, [j, M] = d([T, v], [E, _], { props: A }), N = b("result", t), [P, F] = S(N), I = r(N, `${N}-${u}`, i, C, a, { [`${N}-rtl`]: x === "rtl" }, P, F, j.root), L = r(`${N}-title`, j.title), R = r(`${N}-subtitle`, j.subTitle), z = r(`${N}-extra`, j.extra), B = r(`${N}-body`, j.body), V = r(`${N}-icon`, { [`${N}-image`]: D.includes(`${u}`) }, j.icon), H = {
		...M.root,
		...w,
		...c
	}, U = n(y, {
	...
	return /*#__PURE__*/ g.createElement("div", {
		...
		status: u,
		icon: p
	}), m(s) && /*#__PURE__*/ g.createElement("div", {
		className: L,
		style: M.title
	}, s), m(o) && /*#__PURE__*/ g.createElement("div", {
		className: R,
		style: M.subTitle
	}, o), /*#__PURE__*/ g.createElement(k, {
		className: z,
		extra: h,
		style: M.extra
	}), m(l) && /*#__PURE__*/ g.createElement("div", {
		className: B,
		style: M.body
	}, l));
};
A.PRESENTED_IMAGE_403 = E[403], A.PRESENTED_IMAGE_404 = E[404], A.PRESENTED_IMAGE_500 = E[500];
//#endregion
export { w as t };
