...
import { Dn as n, Mt as r, Nt as i, On as a, Tt as o, _n as s, bn as c, hn as l, vn as u } from "../shared/core.js";
...
var v = /* @__PURE__ */ t(a()), y = /* @__PURE__ */ t(n()), b = (e) => typeof HTMLElement < "u" && e instanceof HTMLElement, x = (e) => {
	let { prefixCls: t, className: n, ...r } = e;
	...
	return !r || !s(r) ? [e, t] : [f(r, { ref: a }), t];
}, D = (...e) => `linear-gradient(to left, ${e.join(", ")}, transparent)`, O = (e) => _(e) ? [{
	color: e,
	percent: 0
}] : e ?? [], k = (e) => {
	let t = e[e.length - 1];
	return !t || t.percent === 100 ? e : [].concat(r(e), [{
		...t,
		percent: 100
	}]);
	...
	let t = j(O(e));
	return t.length ? D.apply(void 0, r(t.map((e) => `${e.color} ${e.percent}%`))) : void 0;
}, N = g("BorderBeam", (e) => {
	let { componentCls: t, antCls: n } = e, [, r] = h(n, "border-beam"), i = `linear-gradient(to left, ${e.colorPrimary} 0%, ${e.colorPrimaryHover} 70%, transparent)`, a = new o("antBorderBeamMove", {
	...
	let { prefixCls: t, className: n, style: r, children: a, color: o, outset: s } = e, { className: c, style: l, getPrefixCls: u } = p("borderBeam"), d = u("border-beam", t), [f, g] = N(d), [_] = h(u(), "border-beam"), [y, b] = E(a), { borderWidth: x, borderRadius: C } = T(b), w = (0, v.useMemo)(() => M(o), [o]), D = (0, v.useMemo)(() => m(s) ? P(s) : x.map(P).join(" "), [x, s]);
