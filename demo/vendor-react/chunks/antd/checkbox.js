...
import { Mt as n, Nt as r, On as i, Ut as a, fn as o, sn as s, vn as c } from "../shared/core.js";
...
var S = /* @__PURE__ */ t(i()), C = /*#__PURE__*/ S.createContext(null), w = /*#__PURE__*/ S.forwardRef((e, t) => {
	let { prefixCls: n, children: i, indeterminate: a = !1, onMouseEnter: f, onMouseLeave: p, skipGroup: w = !1, disabled: T, rootClassName: E, className: D, style: O, classNames: k, styles: A, name: j, value: M, checked: N, defaultChecked: P, onChange: F, ...I } = e, { getPrefixCls: L, direction: R, className: z, style: B, classNames: ee, styles: te } = u("checkbox"), V = S.useContext(C), { isFormItemInput: H } = S.useContext(_), U = S.useContext(h), W = (V?.disabled || T) ?? U, [ne, re] = s(P, N), G = ne, ie = o((e) => {
	...
	S.useEffect(() => {
		...
		K.current?.input && (K.current.input.indeterminate = a);
	}, [a]);
	...
	}, z, D, Q.root, E, ae, Y, X), ce = r(Q.icon, { [`${J}-indeterminate`]: a }, g, X), [le, ue] = b(Z.onClick);
	...
	let { defaultValue: i, children: o, options: s = [], prefixCls: c, className: l, rootClassName: u, style: m, onChange: h, role: g = "group", ..._ } = e, { getPrefixCls: v, direction: y } = S.useContext(p), [b, T] = S.useState(_.value || i || []), [E, D] = S.useState([]);
	S.useEffect(() => {
	...
	}, M = v("checkbox", c), N = `${M}-group`, P = d(M), [F, I] = x(M, P), L = a(_, ["value", "disabled"]), R = s.length ? O.map((e) => /*#__PURE__*/ S.createElement(w, {
		prefixCls: M,
